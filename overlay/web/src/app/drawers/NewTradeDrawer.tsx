...
function executionSideForAddedRow(block: SymbolTradeBlock): "buy" | "sell" {
  if (block.rows.length === 0) return block.side === "long" ? "buy" : "sell";
  return block.side === "long" ? "sell" : "buy";
}
            ...
            {(rowsField) => (
              <div className="flex flex-col gap-2">
                ...
                <Button
                  ...
                  onClick={() =>
                    rowsField.pushValue(
                      emptyExecutionRow(executionSideForAddedRow(block), {
