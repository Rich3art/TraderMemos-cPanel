...
vi.mock("../../lib/hooks/useAuthedAttachmentUrls", () => ({
  useAuthedAttachmentUrls: (ids: string[]) =>
  ...
  attachments: [
    {
      ...
      user_id: "u1",
      setup_id: "s1",
      filename: "clean-breakout.png",
      content_type: "image/png",
      size_bytes: 1200,
      storage_key: "setups/s1/clean-breakout.png",
      created_at: "2026-01-01T00:00:00Z",
    },
    {
      id: "shot-2",
      user_id: "u1",
      setup_id: "s1",
      filename: "failed-breakout.png",
      content_type: "image/png",
      size_bytes: 1400,
      storage_key: "setups/s1/failed-breakout.png",
