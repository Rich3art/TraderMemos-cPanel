...
import { tradeCurrencies } from "@/lib/currencyConversion";
...
export function TradesView({
  ...
  useDisplayTimePrefs();
  const { currency: displayCurrency } = useMoneyFx(currency);
  const rowFx = useCurrencyConverter(displayCurrency, tradeCurrencies(trades));
