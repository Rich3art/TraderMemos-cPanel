...
import type { Account, CashTransaction, EquityPoint, JournalNote, Summary, Trade } from "@/lib/api/types";
  ...
  return (
    <>
      ...
      <DayTradesDrawer
        ...
        dayNotes={dayNotes}
        dayNotesLoading={dayNotesLoading}
        dayNotesError={dayNotesError}
        dayEvents={dayEvents}
        dayEventsLoading={dayEventsLoading}
        dayEventsError={dayEventsError}
        currency={displayCurrency}
        fxRate={fxRate}
