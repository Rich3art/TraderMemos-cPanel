...
export type BrokerConnectKind =
  ...
  | "sync"
  /** A local/VPS terminal posts fills to this server. */
  | "bridge"
...
export const BROKERS: BrokerDef[] = [
  ...
  },
  {
    ...
    brand: "#0B7CBF",
    monogram: "M5",
    formats: "MT4/MT5 bridge, or XLSX/HTML statement",
    steps: [
      "In TraderMemos open Settings → API and generate a personal access token.",
      "Download the MT5 or MT4 bridge file and copy it into MetaTrader's MQL5/Experts or MQL4/Experts folder.",
      "In MetaTrader open Tools → Options → Expert Advisors and allow WebRequest for this TraderMemos server.",
      "Attach the bridge to any chart, paste the server URL, account ID, and token, then leave AutoTrading on.",
    ],
    note: "The bridge syncs from the terminal that runs it. For a one-time catch-up you can still upload an MT5 XLSX or MT4 HTML statement.",
    aliases: ["mt4", "mt5", "metaquotes", "forex", "expert advisor", "ea"],
  },
  {
    key: "tastytrade",
    name: "tastytrade",
...
export const KIND_ORDER: BrokerConnectKind[] = ["sync", "bridge", "file", "manual"];
