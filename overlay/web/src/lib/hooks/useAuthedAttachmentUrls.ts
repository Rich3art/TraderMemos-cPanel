...
const defaultAttachmentFileUrl = (id: string) => `${getBaseUrl()}/attachments/${id}/file`;

export function useAuthedAttachmentUrls(
  attachmentIds: readonly string[],
  fileUrlForId: (id: string) => string = defaultAttachmentFileUrl,
) {
