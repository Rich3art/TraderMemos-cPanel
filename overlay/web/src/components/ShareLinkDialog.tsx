            ...
            <div className="flex flex-col gap-4">
              <ModalBanner>
                <span className="font-medium">
                  {settingsLabel(locale, "sharingPublicWarningTitle")}
                </span>{" "}
                {settingsLabel(locale, "sharingPublicWarningBody")}
              </ModalBanner>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                {expiry === "never" ? (
                  <p className="m-0 text-[12px] leading-relaxed text-destructive">
                    {settingsLabel(locale, "sharingNeverExpiresWarning")}
                  </p>
                ) : null}
              </div>
              <label className="flex items-start gap-2 rounded-lg border border-border bg-muted/40 px-3 py-2.5 text-[12px] leading-relaxed text-muted-foreground">
                <input
                  type="checkbox"
                ...
                />
                <span>{settingsLabel(locale, "sharingAcknowledgePublic")}</span>
              </label>
            </div>
          )}
        </DialogBody>
        <DialogFooter>
          {created ? (
            ...
            <>
              ...
              <Button
                type="button"
                disabled={createLink.isPending || !acknowledged}
                onClick={() => {
                  void handleCreate();
                }}
              >
