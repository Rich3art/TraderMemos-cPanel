...
type Config struct {
	...
	// EconCalendarProvider selects the economic calendar source.
	// Empty/default = official-us. Legacy values: faireconomy, forexfactory.
	EconCalendarProvider string
	// EconCalendarFeedURL overrides the legacy FairEconomy feed URL only when
	// TM_ECON_CALENDAR_PROVIDER=faireconomy|forexfactory.
	...
	// JobAnalyticsEmailIntervalMin is minutes between analytics email checks;
	// 0 disables scheduled analytics emails.
	JobAnalyticsEmailIntervalMin int
	// JobDailyJournalReminderIntervalMin is minutes between daily journal
	// reminder checks; 0 disables scheduled daily log reminders.
	JobDailyJournalReminderIntervalMin int
...
func Load() (Config, error) {
	...
	_ = k.Load(confmap.Provider(map[string]any{
		...
		"econ_calendar_provider":                  "official-us",
		...
		"job_analytics_email_interval_min":        60,
		"job_daily_journal_reminder_interval_min": 15,
	...
	cfg := Config{
		...
		EconCalendarProvider:               k.String("econ_calendar_provider"),
		...
		JobAnalyticsEmailIntervalMin:       k.Int("job_analytics_email_interval_min"),
		JobDailyJournalReminderIntervalMin: k.Int("job_daily_journal_reminder_interval_min"),
