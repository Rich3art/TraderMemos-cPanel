...
func NewProvider(name, feedURL string) Provider {
	...
	case "", "official-us", "official_us", "official":
		return NewOfficialUSProvider()
	case "faireconomy", "forexfactory":
		return NewFairEconomyProvider(feedURL)
	default:
		return NewOfficialUSProvider()
	}
}

// FairEconomyProvider reads the Forex Factory weekly calendar feed.
