...
func (p *PG) DeleteSetupAttachment(ctx context.Context, arg DeleteSetupAttachmentParams) (int64, error) {
	return p.q.DeleteSetupAttachment(ctx, storepg.DeleteSetupAttachmentParams(arg))
}
...
func (p *PG) GetPsychologyQuestions(ctx context.Context, userID string) (PsychologyQuestionSetting, error) {
	v, err := p.q.GetPsychologyQuestions(ctx, userID)
	if err != nil {
		return PsychologyQuestionSetting{}, err
	}
	return PsychologyQuestionSetting(v), nil
}
...
func (p *PG) GetSetupAttachment(ctx context.Context, arg GetSetupAttachmentParams) (SetupAttachment, error) {
	v, err := p.q.GetSetupAttachment(ctx, storepg.GetSetupAttachmentParams(arg))
	if err != nil {
		return SetupAttachment{}, err
	}
	return SetupAttachment(v), nil
}
...
func (p *PG) InsertSetupAttachment(ctx context.Context, arg InsertSetupAttachmentParams) (SetupAttachment, error) {
	v, err := p.q.InsertSetupAttachment(ctx, storepg.InsertSetupAttachmentParams(arg))
	if err != nil {
		return SetupAttachment{}, err
	}
	return SetupAttachment(v), nil
...
func (p *PG) ListAccessTokenUses(ctx context.Context, arg ListAccessTokenUsesParams) ([]AccessTokenUse, error) {
	...
	return func() []AccessTokenUse {
		in := v
		out := make([]AccessTokenUse, len(in))
		for i := range in {
			out[i] = AccessTokenUse(in[i])
		}
		return out
	}(), nil
}
...
func (p *PG) ListAlertChannels(ctx context.Context, userID string) ([]AlertChannel, error) {
	...
	return func() []AlertChannel {
		in := v
		out := make([]AlertChannel, len(in))
		for i := range in {
			out[i] = AlertChannel(in[i])
		}
		return out
	}(), nil
}
...
func (p *PG) ListAlertEvents(ctx context.Context, arg ListAlertEventsParams) ([]AlertEvent, error) {
	...
	return func() []AlertEvent {
		in := v
		out := make([]AlertEvent, len(in))
		for i := range in {
			out[i] = AlertEvent(in[i])
		}
		return out
	}(), nil
}
...
func (p *PG) ListCoachReviews(ctx context.Context, arg ListCoachReviewsParams) ([]CoachReview, error) {
	...
	return func() []CoachReview {
		in := v
		out := make([]CoachReview, len(in))
		for i := range in {
			out[i] = CoachReview(in[i])
		}
		return out
	}(), nil
}
...
func (p *PG) ListEnabledAlertSettings(ctx context.Context) ([]AlertSetting, error) {
	...
	return func() []AlertSetting {
		in := v
		out := make([]AlertSetting, len(in))
		for i := range in {
			out[i] = AlertSetting(in[i])
		}
		return out
	}(), nil
}
...
func (p *PG) ListFlexSyncSettingsForUser(ctx context.Context, userID string) ([]ListFlexSyncSettingsForUserRow, error) {
	...
	return func() []ListFlexSyncSettingsForUserRow {
		in := v
		out := make([]ListFlexSyncSettingsForUserRow, len(in))
		for i := range in {
			out[i] = ListFlexSyncSettingsForUserRow(in[i])
		}
		return out
	}(), nil
}
...
func (p *PG) ListAttachmentsForSetup(ctx context.Context, arg ListAttachmentsForSetupParams) ([]SetupAttachment, error) {
	v, err := p.q.ListAttachmentsForSetup(ctx, storepg.ListAttachmentsForSetupParams(arg))
	if err != nil {
		return nil, err
	}
	return func() []SetupAttachment {
		in := v
		out := make([]SetupAttachment, len(in))
		for i := range in {
			out[i] = SetupAttachment(in[i])
		}
		return out
	}(), nil
}
...
func (p *PG) ListPropSettingsForUser(ctx context.Context, userID string) ([]PropSetting, error) {
	...
	return func() []PropSetting {
		in := v
		out := make([]PropSetting, len(in))
		for i := range in {
			out[i] = PropSetting(in[i])
		}
		return out
	}(), nil
}
...
func (p *PG) UpdateExecutionDetails(ctx context.Context, arg UpdateExecutionDetailsParams) (int64, error) {
	return p.q.UpdateExecutionDetails(ctx, storepg.UpdateExecutionDetailsParams(arg))
}
...
func (p *PG) UpsertPsychologyQuestions(ctx context.Context, arg UpsertPsychologyQuestionsParams) (PsychologyQuestionSetting, error) {
	v, err := p.q.UpsertPsychologyQuestions(ctx, storepg.UpsertPsychologyQuestionsParams(arg))
	if err != nil {
		return PsychologyQuestionSetting{}, err
	}
	return PsychologyQuestionSetting(v), nil
