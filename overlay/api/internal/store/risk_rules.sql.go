...
RETURNING user_id, max_risk_per_trade, max_daily_loss, max_daily_drawdown, max_open_risk, default_account_risk_pct, updated_at, max_trades_per_day, max_consecutive_losses
`
