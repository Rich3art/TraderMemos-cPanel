...
SELECT id, user_id, setup_id, filename, content_type, size_bytes, storage_key, created_at FROM setup_attachments WHERE id = ? AND user_id = ?
`
...
VALUES (?, ?, ?, ?, ?, ?, ?) RETURNING id, user_id, setup_id, filename, content_type, size_bytes, storage_key, created_at
`
...
SELECT id, user_id, setup_id, filename, content_type, size_bytes, storage_key, created_at FROM setup_attachments WHERE setup_id = ? AND user_id = ? ORDER BY created_at
`
