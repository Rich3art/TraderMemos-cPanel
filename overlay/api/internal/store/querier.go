...
type Querier interface {
	...
	DeleteSetupAttachment(ctx context.Context, arg DeleteSetupAttachmentParams) (int64, error)
	...
	GetSetupAttachment(ctx context.Context, arg GetSetupAttachmentParams) (SetupAttachment, error)
	...
	InsertSetupAttachment(ctx context.Context, arg InsertSetupAttachmentParams) (SetupAttachment, error)
