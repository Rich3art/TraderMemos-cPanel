ALTER TABLE payment_transactions ADD COLUMN buyer_label TEXT NOT NULL DEFAULT '';
...
INSERT INTO payment_transactions_privacy_rebuild (
  ...
  amount, currency, subscription_id, raw_json, buyer_label, created_at, updated_at
)
SELECT
  id, user_id, package_id, provider, provider_order_id, provider_capture_id, status,
  amount, currency, subscription_id, raw_json, buyer_label, created_at, updated_at
